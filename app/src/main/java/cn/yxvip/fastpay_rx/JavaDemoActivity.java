...
import top.limuyang2.alipaylibrary.JavaAliPayConsumer;
import top.limuyang2.unionpaylibrary.FastUnionPay;
import top.limuyang2.unionpaylibrary.JavaUnionPayConsumer;
import top.limuyang2.unionpaylibrary.UnionPayType;
import top.limuyang2.wechatpaylibrary.FastWxPay;
import top.limuyang2.wechatpaylibrary.JavaWxPayConsumer;
...
public class JavaDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new FastWxPay("wx7e16cf49c52635e2", this).pay(request, new JavaWxPayConsumer() {
            @Override
        ...
        new FastAliPay(this).pay(orderInfo, new JavaAliPayConsumer() {
            @Override
            public void onCancel() {
        ...
        new FastUnionPay(this).pay(UnionPayType.TEST, tn, new JavaUnionPayConsumer() {
            @Override
            public void onCancel() {
